...
import connector
from Models import additional_methods, Search_period, Cities, EngLvl, Heading

class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(758, 637)
        MainWindow.setMinimumSize(QtCore.QSize(758, 637))
        MainWindow.setMaximumSize(QtCore.QSize(758, 637))
        ...
        self.start_work.setGeometry(QtCore.QRect(20, 580, 731, 51))
        self.start_work.setStyleSheet("background-color: rgb(255, 158, 2);\n"
        "margin-top:4px;\n"
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(20, 10, 731, 131))
        ...
        self.l_email = QtWidgets.QLabel(self.horizontalLayoutWidget_2)
        self.l_email.setObjectName("l_email")
        self.login.addWidget(self.l_email)
        self.email = QtWidgets.QLineEdit(self.horizontalLayoutWidget_2)
        ...
        self.l_password = QtWidgets.QLabel(self.horizontalLayoutWidget_2)
        ...
        self.horizontalLayout_2.addLayout(self.login)
        self.work_log_lay = QtWidgets.QVBoxLayout()
        self.work_log_lay.setObjectName("work_log_lay")
        self.l_work = QtWidgets.QLabel(self.horizontalLayoutWidget_2)
        self.l_work.setObjectName("l_work")
        self.work_log_lay.addWidget(self.l_work)
        self.work_log = QtWidgets.QTextEdit(self.horizontalLayoutWidget_2)
        self.work_log.setStyleSheet("background-color: rgb(255, 255, 255);\n"
        "border: 2px solid rgb(255, 158, 2);\n"
        "color: rgb(0, 0, 0)")
        self.work_log.setObjectName("work_log")
        self.work_log_lay.addWidget(self.work_log)
        self.horizontalLayout_2.addLayout(self.work_log_lay)
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(20, 150, 731, 281))
        self.horizontalLayoutWidget_3.setObjectName("horizontalLayoutWidget_3")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_3)
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.fields_for_search = QtWidgets.QVBoxLayout()
        ...
        self.l_name_of_work = QtWidgets.QLabel(self.horizontalLayoutWidget_3)
        self.l_name_of_work.setObjectName("l_name_of_work")
        self.name_of_work_lay.addWidget(self.l_name_of_work)
        self.name_of_work = QtWidgets.QLineEdit(self.horizontalLayoutWidget_3)
        self.name_of_work.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        self.name_of_work.setStyleSheet("background-color: rgb(255, 255, 255);\n"
        "border: 2px solid rgb(255, 158, 2);\n"
        "color: rgb(0, 0, 0)")
        ...
        self.l_city = QtWidgets.QLabel(self.horizontalLayoutWidget_3)
        self.l_city.setObjectName("l_city")
        self.city_ch.addWidget(self.l_city)
        self.city = QtWidgets.QComboBox(self.horizontalLayoutWidget_3)
        ...
        self.l_period_search = QtWidgets.QLabel(self.horizontalLayoutWidget_3)
        self.l_period_search.setObjectName("l_period_search")
        self.period_serch_lay.addWidget(self.l_period_search)
        self.period_search = QtWidgets.QComboBox(self.horizontalLayoutWidget_3)
        self.period_search.setStyleSheet("background-color: rgb(255, 255, 255);\n"
        "border: 2px solid rgb(255, 158, 2);\n"
        "color: rgb(0, 0, 0)")
        ...
        self.horizontalLayout_3.addLayout(self.fields_for_search)
        ...
        self.varianl_t = QtWidgets.QLabel(self.horizontalLayoutWidget_3)
        self.varianl_t.setObjectName("varianl_t")
        self.variants_of_work.addWidget(self.varianl_t)
        self.variants = QtWidgets.QComboBox(self.horizontalLayoutWidget_3)
        self.variants.setStyleSheet("background-color: rgb(255, 255, 255);\n"
        "border: 2px solid rgb(255, 158, 2);\n"
        "color: rgb(0, 0, 0)")
        ...
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(20, 438, 731, 141))
        self.horizontalLayoutWidget_4.setObjectName("horizontalLayoutWidget_4")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_4)
        self.horizontalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.env_lvl_lay = QtWidgets.QVBoxLayout()
        self.env_lvl_lay.setObjectName("env_lvl_lay")
        self.l_env_lvl = QtWidgets.QLabel(self.horizontalLayoutWidget_4)
        ...
        self.eng_lvl = QtWidgets.QComboBox(self.horizontalLayoutWidget_4)
        self.eng_lvl.setStyleSheet("background-color: rgb(255, 255, 255);\n"
        "border: 2px solid rgb(255, 158, 2);\n"
        "color: rgb(0, 0, 0)")
        ...
        self.resend = QtWidgets.QCheckBox(self.horizontalLayoutWidget_4)
        self.resend.setObjectName("resend")
        self.env_lvl_lay.addWidget(self.resend)
        self.line_4 = QtWidgets.QFrame(self.horizontalLayoutWidget_4)
        self.line_4.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.env_lvl_lay.addWidget(self.line_4)
        self.get_same = QtWidgets.QCheckBox(self.horizontalLayoutWidget_4)
        self.get_same.setObjectName("get_same")
        self.env_lvl_lay.addWidget(self.get_same)
        self.horizontalLayout_4.addLayout(self.env_lvl_lay)
        self.cv_type_lay = QtWidgets.QVBoxLayout()
        self.cv_type_lay.setObjectName("cv_type_lay")
        self.cv_past = QtWidgets.QRadioButton(self.horizontalLayoutWidget_4)
        ...
        self.l_cv_type = QtWidgets.QLabel(self.horizontalLayoutWidget_4)
        self.l_cv_type.setObjectName("l_cv_type")
        self.cv_type_lay.addWidget(self.l_cv_type)
        self.cv_name = QtWidgets.QLineEdit(self.horizontalLayoutWidget_4)
        self.cv_name.setStyleSheet("background-color: rgb(255, 255, 255);\n"
        "border: 2px solid rgb(255, 158, 2);\n"
        "color: rgb(0, 0, 0)")
        self.cv_name.setObjectName("cv_name")
        self.cv_type_lay.addWidget(self.cv_name)
        self.horizontalLayout_4.addLayout(self.cv_type_lay)
        self.verticalLayout_2 = QtWidgets.QVBoxLayout()
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.l_add_letter = QtWidgets.QLabel(self.horizontalLayoutWidget_4)
        self.l_add_letter.setObjectName("l_add_letter")
        self.verticalLayout_2.addWidget(self.l_add_letter)
        self.add_letter = QtWidgets.QTextEdit(self.horizontalLayoutWidget_4)
        self.add_letter.setStyleSheet("background-color: rgb(255, 255, 255);\n"
        "border: 2px solid rgb(255, 158, 2);\n"
        "color: rgb(0, 0, 0)")
        ...
        self.work_log.setReadOnly(True)
